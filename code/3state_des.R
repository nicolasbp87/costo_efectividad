################################################################################
############  Discrete-event simulation of a simple 3-state model   ############
################################################################################
# USAR SICK-SICKER Y CONVERTIRLO A DES
...
# Event rates
r_HS <- 0.05 # rate to become Sick when Healthy
r_SD <- 0.1  # rate to die when Sick
