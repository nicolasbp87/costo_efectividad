...
#******************************************************************************
### MARKOV MODEL - THREE STATE WITH TIME DEPENDENCY SINCE MODEL START ####
#******************************************************************************
...
library("diagram") 
library("darthtools") # Obtained from GitHUb
library("dplyr")
